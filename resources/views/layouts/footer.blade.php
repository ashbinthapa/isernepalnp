        ...
        <div class="row m-5">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="https://www.icpsr.umich.edu/web/ICPSR/search/studies?q=chitwan"> <i class="fa fa-link" aria-hidden="true"></i>
                    <strong>ICPSR</strong>
                    ...
                    <li><a href="https://isernepal.org.np/other-links"> <i class="fa fa-link" aria-hidden="true"></i>
                    Other Links</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
